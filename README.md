...
backend/                   the Python/RAG service (run uv commands from here)
  ...
  evals/                   reproducible evals (chunking comparison, retrieval ranking; flat + structured samples)
...
- **More evals:** embedding quality, and answer-faithfulness for generation.
  Retrieval ranking is already covered by the retrieval ranking eval above.
